			      ...
			      <div class="widget-content padded">
			        <div class="form-horizontal">
			          <div class="form-group">
			            <label class="control-label col-md-2">Select Csv File</label>
			            <div class="col-md-4">
			              <div class="fileupload fileupload-new" data-provides="fileupload">
			                <div class="input-group">
			                  ...
			                  <div class="input-group-btn">
			                    <a onclick="resetBar()" class="btn btn-default fileupload-exists" data-dismiss="fileupload" href="#">Remove</a><span onclick="resetBar()" class="btn btn-default btn-file"><span class="fileupload-new">Select file</span><span onclick="resetBar()" class="fileupload-exists">Change</span><input id="files" type="file"></span>
			                  </div>
			                </div>
			              </div>
			            </div>
			        ...
			        <div class="form-group">
			       		<label class="control-label col-md-2"></label>
							<div class="col-md-7">
								<button id="uploadButton" onclick="resetBar()" class="btn btn-lg btn-primary">Submit</button>
							</div>
					</div>
					<div class="col-md-7">
